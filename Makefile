...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/01/28 16:59:05 by fadwa             #+#    #+#              #
#    Updated: 2026/01/28 16:59:10 by fadwa            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_BONUS_ONLY =\
	...
	$(SRC_BONUS_DIR)/builtin/builtin_bonus.c \
	$(SRC_BONUS_DIR)/builtin/builtin_env_bonus.c \
	$(SRC_BONUS_DIR)/builtin/builtin_dot_bonus.c \
